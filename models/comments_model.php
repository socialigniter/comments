...
{    
    ...
    function get_comments_mine($site_id, $user_id, $module)
    {
    	if ($module == 'all')
    	{
    		$where = array('comments.site_id' => $site_id, 'comments.user_id' => $user_id);
		}
		else
		{
		    $where = array('comments.site_id' => $site_id, 'comments.user_id' => $user_id, 'comments.module' => $module);
		}
