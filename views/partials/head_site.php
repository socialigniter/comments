...
/* Comments List */
div.widget_comments_comments_list		{ width: 550px; margin: 25px 0 0px 0; }
...
ul.comment_actions li a 				{ color: #999999; font-size: 12px; margin-left: 15px; }
...
div.comment_thumbnail					{ float: left; margin: 0 12px 35px 0; }
